      ...
      <div className='mx-1 md:mx-20 mt-5'>
        <Card className='p-2 mt-5 mx-1 shadow-md'>
          ...
          <CardContent className='flex flex-wrap justify-between'>
            <div className='m-1 rounded-lg md:w-[200px] md:h-[240px] bg-[#FAFAFA] p-3'>
      ...
      <div className='mx-1 md:mx-20 mt-5 flex flex-col lg:flex-row'>
        <Card className='p-2 mt-2 mx-1 lg:w-[49%] shadow-md'>
          ...
          <CardContent className='flex flex-wrap'>
            <div className='border border-gray-300 m-1 rounded-lg lg:w-[600px] lg:h-[100px] p-2 flex flex-wrap justify-between'>
              <div className='md:w-[200px] flex flex-col justify-center p-3'>
          ...
          <CardContent className='flex flex-wrap'>
            <div className='border border-gray-300 m-1 rounded-lg w-[100%] p-2'>
              ...
              <div className='flex flex-col lg:flex-row p-3'>
                ...
                <div className='p-1 w-[80%]'>
                  <h2 className='font-bold'>You Have a Burnout Alert</h2>
                  <h4 className=''>Implement 25 minute meetings for a 5 minute break between calls. </h4>
                </div>
                <div className='p-1 flex items-center mr-0'>
                  <Button className='bg-black rounded-full p-1 px-3 text-white'>TAKE ACTION</Button>
                </div>
              ...
              <div className='flex flex-col lg:flex-row p-3'>
                ...
                <div className='p-1 w-[80%]'>
                  <h2 className='font-bold'>Inclusion Scores are Trending Down with New Teammates</h2>
                  <h4 className=''>Ask their opinion in next meeting. </h4>
                </div>
                <div className='p-1 flex items-center mr-0'>
                  <Button className='bg-black rounded-full p-1 px-3 text-white'>TAKE ACTION</Button>
                </div>
